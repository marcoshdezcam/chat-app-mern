...
# 📖 Real-time Chat App <a name="about-project"></a>

> This project is a real-time chat app built using Socket.IO, allowing users to follow and chat with different users in real time.
...
- **Real-time Chat Functionality**: Enables users to send and receive messages instantly using Socket.IO.
- **User Interaction**: Allows users to follow and chat with other online users.
- **MERN Stack Architecture**: Utilizes MongoDB, Express.js, React.js, and Node.js for a robust full-stack application.
