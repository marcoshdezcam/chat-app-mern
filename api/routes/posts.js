...
router.post('/', async (req, res) => {
  ...
  // FOR PLATFORM
  if (!isUrl) {
    base64str = base64_encode(`/usercode/chat_app/api/public/images/${req.body.img}`);
  }

  // FOR LOCAL
//   if (!isUrl) {
//     base64str = base64_encode(`/Users/Farrukh/Desktop/mern-image-sharing-app/api/public/images/${req.body.img}`);
//   }
